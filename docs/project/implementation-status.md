...
| 会员订阅       | `partial` | `/app/membership`                            | Free/Plus/Pro 计划列表、Plisio 美元支付、邀请码兑换与 mock 开通；回调成功后自动开通      |
...
| 管理端其他页   | `partial` | `/admin/memberships`、`/admin/announcements` | 会员订阅列表/取消、Plisio 支付只读核查、邀请码创建/停用与系统公告创建/发布已接 API       |
